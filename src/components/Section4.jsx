  ...
  return (
    <div className='section is-relative p-0'>
        <div style={{
            ...
            <p style={{
                fontSize: '89px'
            }} className='is-uppercase font-trashhand has-text-centered font-dark'>roadmap</p>
            <div className="mt-6 roadMapEntrySpacer"></div>
            ...
            <RoadmapMapEntry entryTopic='community growth' entryImg='/images/3.5.png'>
